...
exports.processRefund = exports.getUserPayments = exports.getBookingPaymentStatus = exports.processBookingPayment = void 0;
const prisma_1 = __importDefault(require("../lib/prisma"));
const errorHandler_1 = require("../middleware/errorHandler");
// Simulate payment processing (in real app, integrate with Stripe/PayPal)
const processPayment = async (amount, paymentMethod, bookingId) => {
...
exports.processBookingPayment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (!bookingId || !paymentMethod) {
        throw (0, errorHandler_1.createError)('Booking ID and payment method are required', 400);
    }
    // Get the booking
    ...
    if (booking.userId !== userId) {
        throw (0, errorHandler_1.createError)('Access denied. You can only pay for your own bookings.', 403);
    }
    // Check if booking is in correct status for payment
    if (booking.status !== 'PENDING' && booking.status !== 'CONFIRMED') {
        throw (0, errorHandler_1.createError)('Booking is not eligible for payment', 400);
    }
    ...
    try {
        ...
        const paymentResult = await processPayment(Number(booking.totalPrice), paymentMethod, bookingId);
        ...
        throw (0, errorHandler_1.createError)(`Payment failed: ${error.message}`, 400);
    }
});
// GET /api/payments/booking/:bookingId - Get payment status for a booking
exports.getBookingPaymentStatus = (0, errorHandler_1.asyncHandler)(async (req, res) => {
...
exports.getUserPayments = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (requestingUserId !== userId && userRole !== 'ADMIN') {
        throw (0, errorHandler_1.createError)('Access denied. You can only view your own payments.', 403);
    }
...
exports.processRefund = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (payment.status !== 'COMPLETED') {
        throw (0, errorHandler_1.createError)('Only completed payments can be refunded', 400);
    }
    // Check if already refunded
    const existingRefund = await prisma_1.default.refund.findFirst({
        where: { paymentId }
    });
    if (existingRefund) {
        throw (0, errorHandler_1.createError)('Payment has already been refunded', 400);
    }
