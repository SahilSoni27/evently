...
<body>
    <div class="container">
        ...
        return handlebars_1.default.compile(baseHtml);
    }
    initializeTemplates() {
...
<p>Best regards,<br>The Evently Team</p>`;
        ...
        this.templates.set('booking-confirmation', handlebars_1.default.compile(bookingConfirmationHtml));
        this.templates.set('event-reminder', handlebars_1.default.compile(eventReminderHtml));
        this.templates.set('waitlist-notification', handlebars_1.default.compile(waitlistNotificationHtml));
        this.templates.set('promotion-notification', handlebars_1.default.compile(promotionNotificationHtml));
    }
    ...
    generateWaitlistNotification(data) {
    ...
    generatePromotionNotification(data) {
